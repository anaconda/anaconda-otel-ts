...
### _OIDC Sample Code_
If implementing using this package against a OIDC server for access_token and refresh_token then the same code [here](https://github.com/anaconda/anaconda-otel-ts/tree/main/example_auth/) is a good place to start. The accompanying documentation is in the README.md file [here](https://github.com/anaconda/anaconda-otel-ts/tree/main/example_auth/README.md).
